...
# lives in a separate repo and is unaffected by the daily commit here.
import argparse
import glob
import json
import re
...
# Server-local copy of the client's src/logic/stations.json: the seed list of
# station codes to summarize. Kept here so this repo runs standalone; refresh
# it (see README) when the client adds or renames stations.
DEFAULT_STATIONS = SCRIPT_DIR.parent / "config" / "stations.json"
DEFAULT_OUT = SCRIPT_DIR.parent / "data" / "daily"
